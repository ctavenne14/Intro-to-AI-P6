...
'''
'''
hidden_layer_1 = tf.contrib.layers.fully_connected(features, 2048 , activation_fn = tf.nn.relu)
hidden_layer_2 = tf.contrib.layers.fully_connected(features, 1024 , activation_fn = tf.nn.relu)
hidden_layer_3 = tf.contrib.layers.fully_connected(features, 512 , activation_fn = tf.nn.relu)
hidden_layer_4 = tf.contrib.layers.fully_connected(features, 128 , activation_fn = tf.nn.relu)
prev_hidden_layer = tf.contrib.layers.fully_connected(features, 32 , activation_fn = tf.nn.relu)

hidden_layer_1 = tf.contrib.layers.fully_connected(features, 1024 , activation_fn = tf.nn.relu)
hidden_layer_2 = tf.contrib.layers.fully_connected(features, 512 , activation_fn = tf.nn.relu)
hidden_layer_3 = tf.contrib.layers.fully_connected(features, 128 , activation_fn = tf.nn.relu)
hidden_layer_4 = tf.contrib.layers.fully_connected(features, 64 , activation_fn = tf.nn.relu)
prev_hidden_layer = tf.contrib.layers.fully_connected(features, 32 , activation_fn = tf.nn.relu)

hidden_layer_1 = tf.contrib.layers.fully_connected(features, 512 , activation_fn = tf.nn.relu)
hidden_layer_2 = tf.contrib.layers.fully_connected(features, 256 , activation_fn = tf.nn.relu)
hidden_layer_3 = tf.contrib.layers.fully_connected(features, 128 , activation_fn = tf.nn.relu)
hidden_layer_4 = tf.contrib.layers.fully_connected(features, 32 , activation_fn = tf.nn.relu)
prev_hidden_layer = tf.contrib.layers.fully_connected(features, 16 , activation_fn = tf.nn.relu)

hidden_layer_1 = tf.contrib.layers.fully_connected(features, 256 , activation_fn = tf.nn.relu)
hidden_layer_2 = tf.contrib.layers.fully_connected(features, 128 , activation_fn = tf.nn.relu)
hidden_layer_3 = tf.contrib.layers.fully_connected(features, 32 , activation_fn = tf.nn.relu)
hidden_layer_4 = tf.contrib.layers.fully_connected(features, 16 , activation_fn = tf.nn.relu)
prev_hidden_layer = tf.contrib.layers.fully_connected(features, 8 , activation_fn = tf.nn.relu)

hidden_layer_1 = tf.contrib.layers.fully_connected(features, 128 , activation_fn = tf.nn.relu)
hidden_layer_2 = tf.contrib.layers.fully_connected(features, 64 , activation_fn = tf.nn.relu)
hidden_layer_3 = tf.contrib.layers.fully_connected(features, 32 , activation_fn = tf.nn.relu)
hidden_layer_4 = tf.contrib.layers.fully_connected(features, 16 , activation_fn = tf.nn.relu)
prev_hidden_layer = tf.contrib.layers.fully_connected(features, 8 , activation_fn = tf.nn.relu)
...
hidden_layer_1 = tf.contrib.layers.fully_connected(features, 256 , activation_fn = tf.nn.relu)
hidden_layer_2 = tf.contrib.layers.fully_connected(features, 128 , activation_fn = tf.nn.relu)
hidden_layer_3 = tf.contrib.layers.fully_connected(features, 64 , activation_fn = tf.nn.relu)
hidden_layer_3 = tf.contrib.layers.fully_connected(features, 32 , activation_fn = tf.nn.relu)
prev_hidden_layer = tf.contrib.layers.fully_connected(features, 16 , activation_fn = tf.nn.relu)

hidden_layer_1 = tf.contrib.layers.fully_connected(features, 512 , activation_fn = tf.nn.elu)
hidden_layer_2 = tf.contrib.layers.fully_connected(features, 256 , activation_fn = tf.nn.elu)
hidden_layer_3 = tf.contrib.layers.fully_connected(features, 128 , activation_fn = tf.nn.elu)
hidden_layer_4 = tf.contrib.layers.fully_connected(features, 32 , activation_fn = tf.nn.elu)
prev_hidden_layer = tf.contrib.layers.fully_connected(features, 16 , activation_fn = tf.nn.elu)
...
logits  = tf.contrib.layers.fully_connected(hidden_layer_1 , n_classes, activation_fn = None) # Defining the final layer. 
